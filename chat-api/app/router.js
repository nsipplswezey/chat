...
const MessagesController = Nodal.require('app/controllers/messages_controller.js');
const V1Messages2Controller = Nodal.require('app/controllers/v1/messages2_controller.js');
...
router.route('/messages/{id}').use(MessagesController);
router.route('/v1/messages2/{id}').use(V1Messages2Controller);
